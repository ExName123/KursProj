...
<body style="background-image: url(background.jpg);" class="container-fluid">
    <header class="container rounded-start rounded-end bg-primary shadow p-3 mt-4 mb-4 rounded">
        ...
        <button style="background-color: #0b5ed7" id="toggleRegionStats" class="btn btn-primary ms-3 mb-0">Статистика регионов</button>
        <button id="toggleDescriptionButton" class="btn btn-primary ms-3">Описание</button>
